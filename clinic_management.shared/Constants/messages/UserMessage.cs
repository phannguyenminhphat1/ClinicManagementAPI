public static class UserMessages
{
    ...
    public const string EMAIL_IS_INVALID = "Email không hợp lệ";

    public const string EMAIL_IS_REQUIRED = "Email không được rỗng !";

    public const string EMAIL_IS_ALREADY_EXIST = "Email đã tồn tại !";
